package com.msvc.catalog.shared.constans;
...
public final class Messages {
    ...
    public static final String INGREDIENT_DELETED = "Ingredient deleted successfully.";
    public static final String INGREDIENT_FOUND = "Ingredient retrieved successfully.";
    ...
    public static final String DRINK_FOUND = "Drink retrieved successfully.";
    public static final String DRINK_CREATED = "Drink created successfully.";
